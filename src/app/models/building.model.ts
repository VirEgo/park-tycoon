...
export const BUILDINGS: BuildingType[] = [
    ...
    { id: 'hedge', name: 'Живая изгородь', category: 'decoration', price: 80, income: 0, color: '#15803d', icon: '🌿', width: 1, height: 1, svgPath: 'assets/buildings/hedge.svg', description: 'Ровная зеленая ограда', satisfies: 'fun', statValue: 4, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'topiary', name: 'Топиарий', category: 'decoration', price: 150, income: 0, color: '#166534', icon: '🌳', width: 1, height: 1, svgPath: 'assets/buildings/topiary.svg', description: 'Фигурно подстриженное дерево', satisfies: 'fun', statValue: 7, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'flowerArch', name: 'Цветочная арка', category: 'decoration', price: 220, income: 0, color: '#f472b6', icon: '💐', width: 1, height: 1, svgPath: 'assets/buildings/flower-arch.svg', description: 'Арка для красивых аллей', satisfies: 'fun', statValue: 9, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'gazebo', name: 'Беседка', category: 'decoration', price: 500, income: 0, color: '#d1d5db', icon: '🏛️', width: 2, height: 2, svgPath: 'assets/buildings/gazebo.svg', description: 'Уютная зона отдыха в центре парка', satisfies: 'energy', statValue: 12, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'picnicTable', name: 'Пикник-стол', category: 'decoration', price: 140, income: 0, color: '#8b5a2b', icon: '🍽️', width: 1, height: 1, svgPath: 'assets/buildings/picnic-table.svg', description: 'Столик для отдыха на свежем воздухе', satisfies: 'energy', statValue: 6, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'directionSign', name: 'Указатель', category: 'decoration', price: 110, income: 0, color: '#92400e', icon: '🪧', width: 1, height: 1, svgPath: 'assets/buildings/direction-sign.svg', description: 'Помогает гостям ориентироваться', satisfies: 'fun', statValue: 3, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'totemPole', name: 'Тотем', category: 'decoration', price: 260, income: 0, color: '#7c2d12', icon: '🗿', width: 1, height: 1, svgPath: 'assets/buildings/totem-pole.svg', description: 'Этно-декор с характером', satisfies: 'fun', statValue: 8, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'rockGarden', name: 'Каменный сад', category: 'decoration', price: 170, income: 0, color: '#9ca3af', icon: '🪨', width: 1, height: 1, svgPath: 'assets/buildings/rock-garden.svg', description: 'Спокойная композиция из камней', satisfies: 'energy', statValue: 5, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'miniWindmill', name: 'Мини-мельница', category: 'decoration', price: 280, income: 0, color: '#e5e7eb', icon: '🌀', width: 1, height: 1, svgPath: 'assets/buildings/mini-windmill.svg', description: 'Декоративная мельница в ретро-стиле', satisfies: 'fun', statValue: 8, isAvailableForVisit: false, allowContinuousBuild: true },
    { id: 'heartBed', name: 'Клумба-сердце', category: 'decoration', price: 130, income: 0, color: '#ef4444', icon: '💗', width: 1, height: 1, svgPath: 'assets/buildings/heart-bed.svg', description: 'Романтичный акцент с цветами', satisfies: 'fun', statValue: 7, isAvailableForVisit: false, allowContinuousBuild: true },
